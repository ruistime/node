...
var bowerRoot = path.join(__dirname, './app/scripts/vendor');
...
module.exports = function(options) {
    ...
    var output = {
        path: path.join(__dirname, "./app/extras/", options.prerender ? "build" : "release")
    ...
    var alias = {
        ...
        ,nodeRoot: nodeRoot
        ,commonBase: appRoot + "/scripts/components/common"
        ,storesBase: appRoot + "/scripts/stores/"
